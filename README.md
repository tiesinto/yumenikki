...
### To simply run the game, download <b><ins>[THIS](https://github.com/tiesinto/yumenikki/releases/download/custom_made/yumenikki_for_dummies.zip)</ins></b> and run <b>START.exe</b>
